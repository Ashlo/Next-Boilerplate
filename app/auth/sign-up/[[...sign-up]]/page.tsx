    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-blue-600 to-purple-600 p-12 text-white">
        <div className="relative z-10 mt-auto">
          <h1 className="text-4xl font-bold mb-4">Join ClinicFlow Today</h1>
          <p className="text-lg text-blue-100 mb-8">
            Transform your medical practice with our comprehensive clinic management solution. Sign up now to streamline your operations and enhance patient care.
          </p>
          <div className="grid grid-cols-2 gap-6 text-sm text-blue-100">
            <div className="flex items-start space-x-3">
              ...
              <span>Efficient Patient Management & Scheduling</span>
            </div>
            <div className="flex items-start space-x-3">
              <svg className="w-5 h-5 mt-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-12">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Start your 30-day free trial. No credit card required.</p>
          </div>
          <SignUp
            appearance={{
              elements: {
